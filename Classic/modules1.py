...
def load_data():
    ...
    with open('words_ones.json', 'r') as words_ones_file: 
        words_ones = json.load(words_ones_file)
    with open('words_zeros.json', 'r') as words_zeros_file: 
        words_zeros = json.load(words_zeros_file)
    ...
    data = np.concatenate([data_b['phrase_len'].values.reshape(-1,1), \
